...
const Projects = () => {
  return (
    <div className='flex flex-col items-center py-20'>
        <h1 className='text-[100px] text-transparent font-semibold text-bold bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 py-[50px] z-[999]'>
            <span>My Projects</span>
        </h1>
        <motion.div
        variants={slideInFromRight(0.5)}
        className='text-[20px] z-[999] top-0 text-bold text-white mb-10 mt-[1px] text-center'>
