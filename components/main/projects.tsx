...
const Projects = () => {
  return (
    <div className='flex flex-col items-center py-2' id='projects'>
        ...
        <div className='h-full w-full flex flex-col md:flex-row gap-10 px-10 justify-around'>
           <ProjectCard 
                src="/projects/Notes4YouMainScreen.png"
            ...
            <ProjectCard 
                src="/projects/moviedb_react_version.png"
                title="MovieDB"
                width={750}
                height={750}
        ...
        <div className='h-full py-[20px] w-full flex flex-col md:flex-row gap-10 px-10'>
            ...
            <ProjectCard 
                src="/projects/multisimproject.png"
            ...
            <ProjectCard 
                src="/projects/engineeringcalc1.png"
        ...
        <div className='h-full py-[20px] w-full flex flex-col md:flex-row gap-10 px-10'>
            ...
            <ProjectCard 
                src="/projects/trafficlightsarduino.png"
